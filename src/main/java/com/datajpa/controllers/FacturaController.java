...
import com.datajpa.models.entity.ItemFactura;
...
public class FacturaController {
	...
	private MessageSource messageSource;
		...
		public String ver(@PathVariable(value = "id") Long id, Model model, RedirectAttributes flash, Locale locale) {
			...
			Factura factura = clienteService.fecthFacturaByIdWithClienteWithItemFacturaWithProducto(id); // clienteService.findFacturaById(id);
	...
	public String crear(@PathVariable(name = "clienteId") Long id, Map<String, Object> model,
